"""
Django settings for unifyd_app2_36806 project.
...
SECRET_KEY = env.str("SECRET_KEY",'asdasd')
...
ROOT_URLCONF = 'unifyd_app2_36806.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'web_build'),os.path.join(BASE_DIR, 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'unifyd_app2_36806.wsgi.application'
...
SENDGRID_API_KEY = env.str("SENDGRID_API_KEY", "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")
EMAIL_HOST = env.str("EMAIL_HOST", "smtp.sendgrid.net")
EMAIL_HOST_USER = env.str("EMAIL_USER", "apikey")
EMAIL_HOST_PASSWORD = SENDGRID_API_KEY
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = env.str("DEFAULT_FROM_EMAIL", "contact@unifyd.com")
...
WEB_URL = env.str("WEB_URL", "https://unifyd-app2-36806.botics.co/login")
